...
def _load_agents_md(cwd_path: Path, mode: str = "full") -> str:
    """AGENTS.md \u2014 hierarchical, recursive directory walk.

    In *smart* mode, only the top-level AGENTS.md plus a small number of
    nested files are loaded.  In *full* mode all discovered files are loaded.
    """
...
def build_context_files_prompt(
    ...
    project_context = (
        ...
        or _load_agents_md(cwd_path, mode=mode_normalized)
